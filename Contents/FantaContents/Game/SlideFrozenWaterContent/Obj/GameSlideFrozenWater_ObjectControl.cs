...
public class GameSlideFrozenWater_ObjectControl : MonoBehaviour
{
    ...
    IEnumerator Cor_Reset()
    {
        ...
        SoundManager.Instance.PauseSound((int)SoundType_GameBGM.SlideFrozenWater);
        SoundManager.Instance.PlaySound((int)SoundType_GameFX.SlideFrozenWater_TapleRe);
        ...
        SoundManager.Instance.PausePlaySound((int)SoundType_GameBGM.SlideFrozenWater);
