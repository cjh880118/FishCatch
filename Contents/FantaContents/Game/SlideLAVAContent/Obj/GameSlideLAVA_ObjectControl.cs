...
public class GameSlideLAVA_ObjectControl : MonoBehaviour
{
    ...
    IEnumerator Cor_Reset()
    {
        ...
        SoundManager.Instance.PauseSound((int)SoundType_GameBGM.SlideLAVA);
        SoundManager.Instance.PlaySound((int)SoundType_GameFX.SlideLAVA_TapleRe);
        ...
        SoundManager.Instance.PausePlaySound((int)SoundType_GameBGM.SlideLAVA);
