...
public class UnicornBeetle_Controller : IFish
{
    ...
    {
        fishType = FishType.UnicornBeetle;
    ...
    public override IEnumerator MoveTarget(Vector3 target, int targetIndex)
    {
        ...
        while (Vector3.Distance(this.gameObject.transform.position, target) > 1f && isCapturePossible)
        {
            ...
            Debug.DrawRay(this.gameObject.transform.position, this.gameObject.transform.forward *5, Color.red);
